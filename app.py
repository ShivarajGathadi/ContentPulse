...
df = pd.read_excel('d:\projects\Mood-Analyzer\Input.xlsx')
for index in range(len(df)):
    ...
    file_name = "D:\projects\Mood-Analyzer\content" + str(urlid) + '.txt'
...
# Getting stop words
stop = set()
stopwords_dir = "D:\projects\Mood-Analyzer\StopWords"
...
content_dir = "D:/projects/Mood-Analyzer/content"
content = []
...
with open("D:\projects\Mood-Analyzer\MasterDictionary\positive-words.txt", 'r', encoding='ISO-8859-1') as f:
    pos.update(f.read().splitlines())

with open("D:\projects\Mood-Analyzer\MasterDictionary\\negative-words.txt", 'r', encoding='ISO-8859-1') as f:
...
for file in os.listdir(content_dir):
  ...
  answer = pd.read_excel("D:\projects\Mood-Analyzer\Output Data Structure.xlsx")
